...
<html>
    ...
    <body>
        ...
        <div class="btnPopis">
            <input id="zupanije" name="zupanije" class="button" type="submit" value="Popis županija">
            <input id="uprave" name="uprave" class="button" type="submit" value="Popis policijskih uprava">
            <input id="djelatnici" name="djelatnici" class="button" type="submit" value="Popis djelatnika">
            </div>
